...
<body>
    ...
    if (isset($_SESSION['organ_donor_contact']) && $_SESSION['organ_donor_contact'] == 'success') { ?>
    ...
    unset($_SESSION['organ_donor_contact']);
    ...
    <div class="dashboard">
        ...
        <div class="doctor-container" id="doctor-container">
            ...
            $sql = "SELECT * FROM `organ-donors` ORDER BY `datetime` DESC";
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="post" id="organ-donor-contact" action="./form-action/user-organ-donor-contact-action">
