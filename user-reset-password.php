...
if (isset($_GET['secret'])) {
    ...
    $sql = "SELECT * FROM `user-login` WHERE `email` = '$email'";
...
?>
        ...
        <head>
            ...
            <style>
                ...
                .reset-password-container .input-group label:first-child {
                    width: 150px
                }
        ...
        <body>
            ...
            <div class="reset-password-container">
                <form action="./form-action/user-password-update" method="post" id="password-update-form">
