            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-secondary" onclick="window.location.href = './logout?user=login'" ;>
                            LOG OUT
                        </button>
...
<body>
    ...
    <div class="form-container">
        <form action="./form-action/user-login-action" method="post" autocomplete="off" id="user-login-form">
            ...
            <div class="form-check form-switch">
                ...
                <div class="text-center" id="forgot-password-container">
                    <a href="./user-forgot-password" id="forgotPassword"> Forgot Password? </a>
                </div>
            </div>
            ...
            <div class="input-group">
                ...
                <button type="button" class="input-group-text" id="reloadCaptcha">
