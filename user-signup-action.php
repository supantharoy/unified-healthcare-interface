...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['user_name_temp'] = $name;
    $_SESSION['user_username_temp'] = $username;
    $_SESSION['user_gender_temp'] = $gender;
    $_SESSION['user_password_temp'] = $password;
...
?>
    ...
    <body>
        ...
        <form action="./form-action/user-signup-finish" method="post" id="verify-email-form">
            <div class="container">
